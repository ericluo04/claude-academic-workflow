...
| `compile-latex --figures` | [`scunning1975/MixtapeTools`](https://github.com/scunning1975/MixtapeTools) | Scott Cunningham | The iterative TikZ refinement concept, extended here into a full compile / rasterize / review / fix loop. |
