---
name: review-pap
description: Run a 6-agent pre-submission review of a pre-analysis plan (PAP) for a specified registration target or journal. Covers clarity/pre-specification, hypothesis-outcome consistency, identification, statistical analysis plan, data/operational feasibility, and an adversarial registry/journal review. Supports marketing (MKSCI, JMR, JCR, MS) and economics journal targets.
---

# Review PAP

> **Source.** This skill is adapted from [`claesbackman/AI-research-feedback`](https://github.com/claesbackman/AI-research-feedback). The 6-agent fanout (Clarity/Pre-spec, Hypotheses/Outcomes, Identification/Causal, Statistical Analysis Plan, Data/Operational, Adversarial Referee) is Claes Bäckman's; this fork extends the registration targets to AEA / EGAP / OSF / ClinicalTrials / ISRCTN and adds marketing journal standards (MKSCI / JMR / JCR / MS).
...
- The recognized registration targets are:
  ...
  - **Marketing journal standards**: `MKSCI`, `JMR`, `JCR`, `MS`
  - **Economics journal standards**: `AER`, `QJE`, `JPE`, `RESTUD`, `AEJ`, `JEEA`
...
5. Search recursively for likely supporting files and record them if present:
   ...
   - Code: files containing `analysis`, `code`, `script`, `mock`
...
- **MKSCI / JMR / JCR / MS**: apply the standards of a top quantitative marketing journal — expect credible identification (structural, reduced-form, or experimental), pre-specification of primary outcomes, adequate power, transparent treatment of substantive marketing relevance and managerial implications, and honest framing of limitations.
...
- **top-journal**: apply high general standards for a competitive marketing, economics, or social science journal without a specific venue persona.
...
**Date**: [Today's date]
**Review Standard**: [TARGET_REGISTRY — if `top-journal`, write "Top Marketing/Economics/Social Science Journal"; if `working-paper`, write "Working Paper / General Pre-Registration Standard"; otherwise write the specific registry or venue name]
