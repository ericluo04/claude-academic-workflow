...
| `/compile-latex` (planned) | [scunning1975/MixtapeTools](https://github.com/scunning1975/MixtapeTools) | Scott Cunningham | `compiledeck` log-parsing approach (not yet ported) |
| `/audit-reproducibility` | [scunning1975/MixtapeTools](https://github.com/scunning1975/MixtapeTools) + [pedrohcgs/claude-code-my-workflow](https://github.com/pedrohcgs/claude-code-my-workflow) | Scott Cunningham + Pedro H.C. Sant'Anna | Claim-extraction → tolerance-comparison flow (Scott) + 5-phase R / Python / Stata multi-language audit topology (Pedro) |
...
| `/email-triage` (planned) | [chrisblattman/claudeblattman](https://github.com/chrisblattman/claudeblattman) | Chris Blattman | `triage-inbox` classification flow (not yet ported) |
